...
public class CafeFindOneResponseDto {
    ...
    public CafeFindOneResponseDto(Cafe cafe) {
        ...
        this.openingHoursMon = cafe.getOpeningHours().getMonday();
        this.openingHoursTues = cafe.getOpeningHours().getTuesday();
        this.openingHoursWed = cafe.getOpeningHours().getWednesday();
        this.openingHoursThurs = cafe.getOpeningHours().getThursday();
        this.openingHoursFri = cafe.getOpeningHours().getFriday();
        this.openingHoursSat = cafe.getOpeningHours().getSaturday();
        this.openingHoursSun = cafe.getOpeningHours().getSunday();
    }
